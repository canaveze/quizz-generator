...
-- Fix data types in existing tables
ALTER TABLE public."Quizzes" ALTER COLUMN user_id TYPE UUID USING user_id::uuid;
ALTER TABLE public."Questions" ALTER COLUMN question_text TYPE TEXT;
ALTER TABLE public."Results" ALTER COLUMN user_id TYPE UUID USING user_id::uuid;
